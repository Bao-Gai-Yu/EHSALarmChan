...
public class Alarm {
    ...
    static int lUserID66 = -1;//用户句柄 实现对设备登录
    static int lUserID67 = -1;//用户句柄 实现对设备登录
    static int lUserID68 = -1;//用户句柄 实现对设备登录
    static int lUserID70 = -1;//用户句柄 实现对设备登录
    static int lAlarmHandle66 =-1;//报警布防句柄
    static int lAlarmHandle67 =-1;//报警布防句柄
    static int lAlarmHandle68 =-1;//报警布防句柄
    static int lAlarmHandle70 =-1;//报警布防句柄
    ...
    static String cameraUserName = "admin";
    static String cameraPassword = "AEG111aeg";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        lUserID66=Alarm.loginDevice( "192.168.14.66", (short) 8000, cameraUserName, cameraPassword);  //登录设备
        System.out.println("正在对192.168.14.66的摄像头进行布防...");
        lAlarmHandle66=Alarm.setAlarmChan(lAlarmHandle66, lUserID66);//报警布防

        lUserID67=Alarm.loginDevice( "192.168.14.67", (short) 8000, cameraUserName, cameraPassword);  //登录设备
        System.out.println("正在对192.168.14.67的摄像头进行布防...");
        lAlarmHandle67=Alarm.setAlarmChan(lAlarmHandle67, lUserID67);//报警布防

        lUserID68=Alarm.loginDevice( "192.168.14.68", (short) 8000, cameraUserName, cameraPassword);  //登录设备
        System.out.println("正在对192.168.14.68的摄像头进行布防...");
        lAlarmHandle68=Alarm.setAlarmChan(lAlarmHandle68, lUserID68);//报警布防

        lUserID70=Alarm.loginDevice( "192.168.14.70", (short) 8000, cameraUserName, cameraPassword);  //登录设备
...
//        AlarmDataParse.handleAlarmDataToEHS("2025-06-12 17:10:20", "192.168.14.68", "./pic/192.168.14.66_2025-06-12-15-59-51-000_VideoData.json","./pic/192.168.14.66_2025-06-12-15-59-51-000_VideoPic.jpg");
        ...
        //设备注销
        Alarm.logoutDev(lUserID66);
        Alarm.logoutDev(lUserID67);
        Alarm.logoutDev(lUserID68);
        Alarm.logoutDev(lUserID70);
        //释放SDK
...
//    }
     ...
     * @return
     */
    public static  int setAlarmChan(int lAlarmHandle, int userID ) {
        if (userID == -1) {
